...
// initial board: 6 reels x 4 rows (+ padding top/bottom = 6 symbols per reel)
...
export const BLOCKER_SYMBOLS = ['B1', 'B2', 'B3'];
...
const b1Static = { type: 'sprite', assetKey: 'b1.webp', sizeRatios: { width: BLOCKER_SYMBOL_SIZE, height: BLOCKER_SYMBOL_SIZE } };
const b2Static = { type: 'sprite', assetKey: 'b2.webp', sizeRatios: { width: BLOCKER_SYMBOL_SIZE, height: BLOCKER_SYMBOL_SIZE } };
const b3Static = { type: 'sprite', assetKey: 'b3.webp', sizeRatios: { width: BLOCKER_SYMBOL_SIZE, height: BLOCKER_SYMBOL_SIZE } };
...
export const SYMBOL_INFO_MAP = {
	...
	W: {
		...
		static: wStatic,
		spin: wStatic,
		win: { type: 'spine', assetKey: 'W', animationName: 'wild_tnt_explode', sizeRatios: wSizeRatios },
		land: {
			type: 'spine',
			assetKey: 'W',
			animationName: 'wild_tnt_land',
	...
	B1: {
		explosion: {
			type: 'spine',
			assetKey: 'blocker_destroy',
			animationName: 'bronze_destroy',
			sizeRatios: { width: 1.2, height: 1.2 },
		},
		win: b1Static,
		postWinStatic: b1Static,
		static: b1Static,
		spin: b1Static,
		land: b1Static,
		blockerDestroy: {
	...
	B2: {
		explosion: {
			type: 'spine',
			assetKey: 'blocker_destroy',
			animationName: 'silver_destroy',
			sizeRatios: { width: 1.2, height: 1.2 },
		},
		win: b2Static,
		postWinStatic: b2Static,
		static: b2Static,
		spin: b2Static,
		land: b2Static,
		blockerDestroy: {
	...
	B3: {
		explosion: {
			type: 'spine',
			assetKey: 'blocker_destroy',
			animationName: 'diamond_destroy',
			sizeRatios: { width: 1.2, height: 1.2 },
		},
		win: b3Static,
		postWinStatic: b3Static,
		static: b3Static,
		spin: b3Static,
		land: b3Static,
		blockerDestroy: {
